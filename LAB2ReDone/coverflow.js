...
coverflowimages({
	coverid: 'coverflow1',
	images: [
						['Mapicha/Freekick.JPG','Mapicha/Freekick.JPG', 'Exhibit A'],
						['Mapicha/Defenders.JPG', 'Mapicha/Defenders.JPG', 'Exhibit B.'],
						['Mapicha/Paaaas.JPG', 'Mapicha/Paaaas.JPG', 'Exhibit C'],
						['Mapicha/Slide.JPG', 'Mapicha/Slide.JPG', 'Exhibit D'],
						['Mapicha/Mzoefu.JPG','Mapicha/Mzoefu.JPG', 'Exhibit E'],
						['Mapicha/Nimeumia.JPG','Mapicha/Nimeumia.JPG', 'Exhibit F'],
						['Mapicha/Nyayo.JPG','Mapicha/Nyayo.JPG', 'Exhibit G'],
						['Mapicha/TeamKubwa.JPG','Mapicha/TeamKubwa.JPG', 'Exhibit H'],
						['Mapicha/Through.JPG', 'Mapicha/Through.JPG', 'Exhibit I'] // <-- no comma after last image
